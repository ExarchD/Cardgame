...
*/
    ...
    game_server.createGame = function(player, gameinfo) {

            //Create a new game instance
	    console.log(gameinfo.gameid);
        var thegame = {
                id : gameinfo.gameid,                //generate a new id for the game
                type : gameinfo.gametype,                //generate a new id for the game
    ...
    game_server.findGame = function(player, gameinfo) {
        ...
        if(this.game_count) {
            ...
            for(var gameid in this.games) {
                ...
                if( gameid != gameinfo.gameid ) continue;
                    //get the game we are checking against
                var game_instance = this.games[gameinfo.gameid];

                    //If the game is a player short
                if(game_instance.player_count < game_configs[gameinfo.type].players) {
            ...
            if(!joined_a_game) {
                ...
                this.createGame(player, gaminfo);
                ...
                //no games? create one!
            this.createGame(player, gameinfo);
        }
